...
<html>
    <head>
        ...
        <style>
            ...
            #sidebar {
                width: 200px; background: #ECF5E4; border-right: 1px solid #231F20;
            ...
            #firstNameField, #lastNameField, #loginField, #passwordField, #confirmPasswordField, #phoneField {
    ...
    <div id="content">
        ...
        <p><label for="lastNameField">Фамилия:</label><input type="text" name="lastName" id="lastNameField" required></p>
        <p><label for="phoneField">Телефон:</label><input type="tel" name="phone" id="phoneField"></p>
        <p><label for="loginField">Email:</label><input type="email" name="email" id="loginField" required></p>
        <p><label for="passwordField">Пароль:</label><input type="password" name="password" id="passwordField" required></p>
        <p><label for="confirmPasswordField">Подтверждение пароля:</label><input type="password" name="confirmPassword" id="confirmPasswordField" required></p>
