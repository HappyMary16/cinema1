...
<div id="content">
    <table>
        ...
        %>
        <tr>
            <td class="text"><a href="/admin/user?id=<%= user.getId() %>"><%= i%></a>
            </td>
            <td class="text"><a href="/admin/user?id=<%= user.getId() %>"><%= user.getFirstName()%></a>
            </td>
            <td class="text"><a href="/admin/user?id=<%= user.getId() %>"><%= user.getLastName() %></a>
            </td>
            <td class="text"><a href="/admin/user?id=<%= user.getId() %>"><%= user.getLogin() %></a>
            </td>
            <td class="text"><a href="/admin/user?id=<%= user.getId() %>"><%= user.getPhone() %></a>
            </td>
            <td class="text"><a href="/admin/user?id=<%= user.getId() %>"><%= user.getEmail() %></a>
            </td>
            <td class="list"><a href="/admin/users/delete?id=<%= user.getId()%>">Delete</a></td>
        </tr>
        <%
            }
        %>
