...
<div id="content">
    <form action="/admin/films/studios/add" method="post">
        <p><label for="studio">Studio:</label>
            <input type="text" name="studio" id="studio" required></p>
        <button type="submit">Add studio</button>
    </form>
    <table>
        <tr>
            <th class="title">№</th>
            <th class="title">Studio</th>
        </tr>
        <%
            int i = 0;
            for (Studio entity :
