...
<div id="content">
    <h3>Add new seance:</h3><br>
    <form action="/admin/add_seance" method="post">
        ...
        <p><label for="date">Date:</label><input type="date" name="date" id="date" required>
        </p>
        <p><label for="time">Time:</label><input type="time" name="time" id="time" required></p>
        ...
        <p><label for="price">Price:</label><input type="number" name="price" id="price" required></p>
